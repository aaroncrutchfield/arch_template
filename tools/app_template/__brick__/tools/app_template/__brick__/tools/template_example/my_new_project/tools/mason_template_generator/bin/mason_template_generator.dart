...
void main(List<String> args) async {
  final parser = ArgParser()
    ...
    ..addOption(
      ...
      abbr: 's',
      help:
          'Source directory of the Flutter project (defaults to parent of tools directory)',
      defaultsTo: path
  ...
  try {
    ...
    final generator = MasonTemplateGenerator(
      sourceDir: Directory(results['source'] as String),
    ...
    print(
        'Usage: dart run mason_template_generator.dart -o <output_directory> [-s <source_directory>]');
    exit(1);
  }
}
...
class MasonTemplateGenerator {
  ...
  final _ignorePatterns = [
    ...
    RegExp(r'\.log$'),
    RegExp(
        r'tools/mason_template_generator/'), // Ignore the generator tool itself
  ];

  Map<String, String> get _replacements => {
        _projectName: 'my_new_project',
        _toTitleCase(_projectName): '',
        _projectName.toLowerCase(): '',
      };

  Future<void> generate() async {
    print('Generating Mason brick from $_projectName...');
    print('Source directory: ${_sourceDir.path}');
